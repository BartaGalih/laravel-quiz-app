    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="flex w-full w-screen main-content">
            <div class="left-part flex-1 min-w-0">
                <div class="bg-white border-b border-gray-200 px-8 py-4 flex items-center gap-4 h-16">
                    {{-- Search --}}
                    ...
                    <main class="flex-1 p-8 border-r border-gray-200">
                        <div class="grid grid-cols-3 gap-5">
                            ...
                            @foreach ($courses as $course)
                                <div onclick="window.location.href='/course/{{ $course['id'] }}'"
                                    class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex flex-col gap-4 cursor-pointer hover:shadow-md transition-shadow">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span
                                            class="text-xs font-semibold text-gray-400 bg-gray-100 rounded px-1.5 py-0.5 whitespace-nowrap">
                                            {{ $course['progress'] }}%
                                        </span>
                                    </div>
